...
class EcoTaxaGenerator(utils.Sequence):
    ...
    """
    def __init__(self, images_paths, input_shape, features_lists=None, labels=None, classes=None, batch_size=32,
    ...
    def __getitem__(self, index):
        ...
        if self.features_lists is not None:
            batch_features_lists = np.array([self.features_lists[i] for i in indexes], dtype='float32')
            return [batch_prepared_images, batch_features_lists], batch_encoded_labels
